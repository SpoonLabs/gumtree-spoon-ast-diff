...
public class CmiContext extends AbsContext implements Context {
     ...
     */
    public CmiContext(Context cmiContextOLD) {
        super(cmiContextOLD);
    }
     ...
     */
    protected Object unwrapObject(Object o, Name name111) throws NamingException {
        return super.defaultUnwrapObject(o, name111);
    }
